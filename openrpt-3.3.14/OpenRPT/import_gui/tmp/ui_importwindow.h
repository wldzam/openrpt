...
public:
    ...
    {
        ImportWindow->setWindowTitle(QCoreApplication::translate("ImportWindow", "Report Import Tool", nullptr));
        ...
        groupBox1->setTitle(QCoreApplication::translate("ImportWindow", "Reports", nullptr));
