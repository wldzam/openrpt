...
void LogOutput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LogOutput *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject LogOutput::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_LogOutput.data,
    qt_meta_data_LogOutput,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LogOutput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::LogOutput"))
        return static_cast< Ui::LogOutput*>(this);
