...
public:
    ...
    {
        PathEditor->setWindowTitle(QCoreApplication::translate("PathEditor", "Stroke properties", nullptr));
        _lblWidth->setText(QCoreApplication::translate("PathEditor", "Width:", nullptr));
        _gbStyle->setTitle(QCoreApplication::translate("PathEditor", "Style", nullptr));
        _rbSolidStyle->setText(QString());
        _rbDashedStyle->setText(QString());
        _rbDottedStyle->setText(QString());
        _btnAccept->setText(QCoreApplication::translate("PathEditor", "&OK", nullptr));
        _btnCancel->setText(QCoreApplication::translate("PathEditor", "&Cancel", nullptr));
        _btnColor->setText(QCoreApplication::translate("PathEditor", "Color...", nullptr));
    } // retranslateUi
