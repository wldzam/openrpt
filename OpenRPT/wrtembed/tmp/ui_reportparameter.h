...
public:
    ...
    {
        ReportParameter->setWindowTitle(QCoreApplication::translate("ReportParameter", "Parameter", nullptr));
        _lblName->setText(QCoreApplication::translate("ReportParameter", "Name:", nullptr));
        _lblType->setText(QCoreApplication::translate("ReportParameter", "Type:", nullptr));
        _cbType->setItemText(0, QCoreApplication::translate("ReportParameter", "String", nullptr));
        _cbType->setItemText(1, QCoreApplication::translate("ReportParameter", "Integer", nullptr));
        _cbType->setItemText(2, QCoreApplication::translate("ReportParameter", "Double", nullptr));
        _cbType->setItemText(3, QCoreApplication::translate("ReportParameter", "Bool", nullptr));

        _active->setText(QCoreApplication::translate("ReportParameter", "Active", nullptr));
        _lblDefault->setText(QCoreApplication::translate("ReportParameter", "Default:", nullptr));
        _btnOk->setText(QCoreApplication::translate("ReportParameter", "&OK", nullptr));
        _btnCancel->setText(QCoreApplication::translate("ReportParameter", "&Cancel", nullptr));
        _tab->setTabText(_tab->indexOf(description), QCoreApplication::translate("ReportParameter", "Description", nullptr));
        _listType->setTitle(QCoreApplication::translate("ReportParameter", "List Type", nullptr));
        _staticList->setText(QCoreApplication::translate("ReportParameter", "Static", nullptr));
        _dynamicList->setText(QCoreApplication::translate("ReportParameter", "Dynamic", nullptr));
        _lblStatic->setText(QCoreApplication::translate("ReportParameter", "Static List Values:", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = _listValues->headerItem();
        ___qtreewidgetitem->setText(1, QCoreApplication::translate("ReportParameter", "Label", nullptr));
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("ReportParameter", "Value", nullptr));
        _add->setText(QCoreApplication::translate("ReportParameter", "Add", nullptr));
        _edit->setText(QCoreApplication::translate("ReportParameter", "Edit", nullptr));
        _remove->setText(QCoreApplication::translate("ReportParameter", "Remove", nullptr));
        _lblDynamic->setText(QCoreApplication::translate("ReportParameter", "Dynamic List Query:", nullptr));
        _tab->setTabText(_tab->indexOf(lists), QCoreApplication::translate("ReportParameter", "Defined List", nullptr));
    } // retranslateUi
