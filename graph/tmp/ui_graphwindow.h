...
public:
    ...
    {
        GraphWindow->setWindowTitle(QCoreApplication::translate("GraphWindow", "Graph Window", nullptr));
        _gbLabel->setTitle(QCoreApplication::translate("GraphWindow", "Labels", nullptr));
        _dataLabel->setText(QCoreApplication::translate("GraphWindow", "Data:", nullptr));
        _titleLabel->setText(QCoreApplication::translate("GraphWindow", "Title:", nullptr));
        _valueLabel->setText(QCoreApplication::translate("GraphWindow", "Value:", nullptr));
        _gbPadding->setTitle(QCoreApplication::translate("GraphWindow", "Padding (in pixels)", nullptr));
        _vPadLabel->setText(QCoreApplication::translate("GraphWindow", "Vertical:", nullptr));
        _hPadLabel->setText(QCoreApplication::translate("GraphWindow", "Horizontal:", nullptr));
        _gbValueRange->setTitle(QCoreApplication::translate("GraphWindow", "Value Range", nullptr));
        _maxValueLabel->setText(QCoreApplication::translate("GraphWindow", "Max:", nullptr));
        _minValueLabel->setText(QCoreApplication::translate("GraphWindow", "Min:", nullptr));
        _btnClear->setText(QCoreApplication::translate("GraphWindow", "Clear All", nullptr));
        _styleGroup->setTitle(QCoreApplication::translate("GraphWindow", "Graph Style", nullptr));
        _cbBars->setText(QCoreApplication::translate("GraphWindow", "Bars", nullptr));
        _cbLines->setText(QCoreApplication::translate("GraphWindow", "Lines", nullptr));
        _cbPoints->setText(QCoreApplication::translate("GraphWindow", "Points", nullptr));
        _numSetLabel->setText(QCoreApplication::translate("GraphWindow", "Number of Sets:", nullptr));
        _numRefLabel->setText(QCoreApplication::translate("GraphWindow", "Number of References:", nullptr));
        QTableWidgetItem *___qtablewidgetitem = _labelTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("GraphWindow", "Label", nullptr));
        _gbSql->setTitle(QCoreApplication::translate("GraphWindow", "Populate with SQL", nullptr));
        _btnSql->setText(QCoreApplication::translate("GraphWindow", "Execute", nullptr));
    } // retranslateUi
